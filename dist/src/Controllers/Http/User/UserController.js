...
var user_json_1 = require("./user.json");
var connection_1 = __importDefault(require("../../../config/database/connection"));
var arrayPeoples = [];
exports.default = {
    ...
    index2: function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    user = connection_1.default("users").select();
                    return [2 /*return*/, res.status(200).json({
                            user: user,
                        })];
                }
    ...
    store: function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    arr = user_json_1.results;
                    user = connection_1.default("users").insert(user_json_1.results[0]);
                    return [2 /*return*/, res.status(200).json({
